...
import { Knjiga } from "./app/shared/models/Knjiga";
import { Zanr } from "./app/shared/models/Zanr";


export const primeri_zanrova: Zanr[] = [
  {
    ime: 'drama',
    broj: 3
  },
  {
    ime: 'naučna fantastika',
    broj: 1
  },
  {
    ime: 'istorijski',
...
export const primeri_knjiga: Knjiga[] = [
  ...
  },
  {
    ...
    godina:'2007.',
    jezik:'srpski',
    slikaUrl:'assets/knjiga-2.jpg',
    ocena: 8.0
  },
  {
    id: '3',
    naziv: 'Na zemlji smo nakratko predivni',
    autor: [''],
    zanr: ['drama'],
    izdavac: 'Konrast izdavaštvo',
    godina:'2021.',
    jezik:'srpski',
    slikaUrl:'assets/knjiga-3.jpg',
    ocena: 8.0
  },
  {
    id: '4',
    naziv: 'Ne daj mi nikada da odem',
    autor: [''],
    zanr: ['naučna fantastika'],
    izdavac: 'Dereta',
    godina:'2020.',
    jezik:'srpski',
    slikaUrl:'assets/knjiga-4.jpg',
    ocena: 8.2
  },
  {
    id: '5',
    naziv: 'Katedrala na moru',
    autor: [''],
    zanr: ['istorijski','triler'],
    izdavac: 'Laguna',
    godina:'2008.',
    jezik:'srpski',
    slikaUrl:'assets/knjiga-5.jpg',
    ocena: 8.4
  }
